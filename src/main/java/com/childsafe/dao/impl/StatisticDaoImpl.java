...
//    public JSONObject getBullyAverageStat() {
//        Session session = sessionFactory.getCurrentSession();
//
...
//            {
//                Map row = (Map)object;
//                obj.put("2012", row.get("AVGBULLY2012"));
//                obj.put("2013", row.get("AVGBULLY2013"));
//                obj.put("2014", row.get("AVGBULLY2014"));
//                obj.put("2015", row.get("AVGBULLY2015"));
//                obj.put("2016", row.get("AVGBULLY2016"));
//
//            }
//            System.out.println("bully:"+obj.toJSONString());
//
//            return obj;
//
//    }

//    public JSONObject getSexualAverageStat() {
//        Session session = sessionFactory.openSession();
...
//        for (Object object : sexualData) {
//            Map row = (Map) object;
//            obj.put("2012", row.get("AVGSEXUAL2012"));
//            obj.put("2013", row.get("AVGSEXUAL2013"));
//            obj.put("2014", row.get("AVGSEXUAL2014"));
//            obj.put("2015", row.get("AVGSEXUAL2015"));
//            obj.put("2016", row.get("AVGSEXUAL2016"));
//
//        }
//        transaction.commit();
//        session.close();
//        System.out.println("sexual:" + obj.toJSONString());
//
//        return obj;
//
//
...
//    public JSONObject getCrimeAverageStat() {
//        Session session = sessionFactory.getCurrentSession();
//        Query crimeQuery = session.createQuery("SELECT   ROUND(avg(stat12),2) as AVGCRIME2012, ROUND(avg(stat13),2) as AVGCRIME2013, ROUND(avg(stat14),2) as AVGCRIME2014, ROUND(avg(stat15),2) as AVGCRIME2015, ROUND(avg(stat16),2) as AVGCRIME2016 FROM Statistic  where type='crime'");
//        crimeQuery.setResultTransformer(Criteria.ALIAS_TO_ENTITY_MAP);
//        List crimeData = crimeQuery.list();
...
//        for(Object object : crimeData) {
//            Map row = (Map) object;
//            obj.put("2012", row.get("AVGCRIME2012"));
//            obj.put("2013", row.get("AVGCRIME2013"));
//            obj.put("2014", row.get("AVGCRIME2014"));
//            obj.put("2015", row.get("AVGCRIME2015"));
//            obj.put("2016", row.get("AVGCRIME2016"));
//
//        }
//
//        System.out.println("crime:"+obj.toJSONString());
//        return obj;
//    }
