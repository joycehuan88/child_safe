                ...
                <div class="row">
                    ...
                    <div class="col-lg-12" ng-show="checkboxModel.value6">
                        ...
                        <div class="col-md-6" style="padding-top: 20px">
                            ...
                            <p>
                                Never say they are alone if they answer the phone. They can offer to take a message or
                                say their
                            ...
                            <p>Not take candy or other gifts from strangers or anyone else without asking a parent
                                first.</p>
                    ...
                    <div class="col-lg-12" ng-show="checkboxModel.value3"
                        ...
                        <div class="col-md-6" style="padding-top: 20px">
                            <h3>Tips your child should know</h3>
                            <p>
                                Immunisation is the most significant public health intervention in the last 200 years,
                                providing a
                    ...
                    <div class="col-lg-12" ng-show="checkboxModel.value2"
                        ...
                        <div class="col-md-6" style="padding-top: 20px">
                            ...
                            <p>Child abuse is any action by another person – adult or child – that causes significant
                                harm to a
                                child. It can be physical, sexual or emotional, but can just as often be about a lack of
                                love, care and
                    ...
                    <div class="col-lg-12" ng-show="checkboxModel.value8" style="padding-top: 30px;margin-top: 30px;padding-bottom: 30px;">
                        ...
                        <div class="col-md-6" style="padding-top: 20px">
                            ...
                            <p>7. encourage children to tell someone they trust if anyone tries to touch their private
                                parts</p>
                            <p>8. carefully consider who else you might want your children to tell if you are not
                                available — let
                                your children know these contact options.</p>
                            <p>9. speak to children who are under school age about personal safety in simple language
                                and
                                repeat the same rules often — play ‘what if’ games to reinforce the message</p>
                            <p>10. teach children of primary school age basic family safety rules and how to apply them
                                in
                                potentially dangerous situations</p>
                            <p>11. assist adolescents to think independently, and to develop decision-making and
                                assertiveness
                                skills</p>
                            <p>12. know who is supervising your children when they are away from home</p>
                            <p>13. listen to your children and trust what they say, even if it shocks you — children
                                rarely make up
